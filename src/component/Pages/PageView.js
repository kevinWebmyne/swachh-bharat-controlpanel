...
const PageView = () => {
    ...
    const getProductsData = async () => {
        const { data } = await axios.get(`http://localhost:3001/api/noAuth/pages/?page=${page}&size=${size}`)
    ...
    const deleteHandle =  (id) => {
        ...
        let body = "";
            ...
            if (window.confirm(text) == true) {
                console.log(auth);
                 axios.put(`http://localhost:3001/api/page/delete/${id}`, body  ,{
