...
const OurImpactView = () => {
    ...
    const deleteHandle = (id) => {
        ...
        if (window.confirm(text) == true) {
             axios.put(`http://localhost:3001/api/impact/delete/${id}`, body ,  {
    ...
    const getProductsData = async () => {
        const { data } = await axios.get(`http://localhost:3001/api/noAuth/impact/?page=${page}&size=${size}`)
